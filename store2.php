    ...
    <main id="main-site">
        ...
        <div class="container mt-5">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                for ($row['start_date']; $row['start_date'] > date('Y/m/d'); $row['start_date'] < date('Y/m/d')) {
                    ...
                    echo '<div class="card mt-3"  style="width: 18rem; text-align:center;">
                        <img class="card-img-top" src="admin/image/' . $row['flyers_img'] . '" alt="Card image cap">
                        <div class="card-body">
                            <a href="' . $url . '" name="query">
                                <h5 class="card-title">' . $row['store_name'] . ' Weekly Ad</h5>
                            </a>
