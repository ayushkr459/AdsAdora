...
<head>
    ...
    <title>Ideas for boosting your Restaurant Websites post lock-down | AdsAdora | Weekly Ads, Sales and Ads Preview</title>
    <style>
        /* Modal Style */
    ...
    <main id="main-site" style="min-height: 100vh;">
        ...
        <div style="background: url(https://i.postimg.cc/3N7wnb75/background.jpg)" class="jumbotron bg-cover text-white">
            <div class="container py-5 text-center">
                <h1 class="display-4 font-weight-bold">Ideas for boosting your Restaurant Websites post lock-down</h1>
                <p class="font-italic mb-0">No one likes to wait for long times when it comes to deciding and ordering their favorite meals. Delivering food is a vital part of the restaurant industry. The ease of ordering, availability of dishes, and delivery time are some of the main factors that would help a restaurant receive a high rating.
            </p>
...
<p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;'><span style="font-size:16px;line-height:107%;">The plotting and outline of your restaurant website have a direct impact on your consumers and in turn, can greatly influence your sales.</span><span style="font-size:16px;line-height:107%;">&nbsp;</span></p>
<p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;'><span style="font-size:16px;line-height:107%;">Think of your website as your online shop window. It needs to be designed to be attractive to your customers. Your customers want to know all about your business and what you can offer them. They also want to feel good when they are on your website. They want to feel like there is a real human being behind the technological screen and that they will receive good service.</span></p>
